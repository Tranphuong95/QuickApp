...
import { getEntity } from './editor.reducer';
...
export const EditorDetail = (props: IEditorDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/editor" replace color="info">
        ...
        &nbsp;
        <Button tag={Link} to={`/editor/${editorEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(EditorDetail);
